		...
		<div class="col-lg-4 col-md-6 mb-4">
			<div class="card h-100">
				...
				<div class="card-footer">
					<a href="{{route('checkout')}}" class="addtocart btn btn-info btn-sm" data-id="{{$item->id}}" data-name="{{$item->name}}" data-photo="{{asset($item->photo)}}" data-price="{{$item->price}}" data-discount="{{$item->discount}}">Add To Card</a>
